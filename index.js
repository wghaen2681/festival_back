...
import festivalRouter from './routes/festivals.js'
import articleRouter from './routes/articles.js'
import assistRouter from './routes/assists.js'
...
app.use('/users', userRouter) // 當路由為 /festivals 時，使用上方引入的 userRouter 控制器
